...
const ModalMedium = ({ isOpen, onClose, title, content, ButtonFooter, position, target }) => {
    const top = position === "top" ? { position: "absolute", top: 30, width: '600px', padding: '24px' } : { width: '600px', padding: '24px' }
    return (
