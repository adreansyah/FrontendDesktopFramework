...
export const getPost = id => {
    return async dispatch => {
        try {
            ...
            const response = await Services('https://jsonplaceholder.typicode.com').get(`/posts/${id}`)
...
export const getPosts = () => {
    return async dispatch => {
        try {
            ...
            const response = await Services('https://jsonplaceholder.typicode.com').get(`/posts`)
...
export const getPostsByUser = userId => {
    return async dispatch => {
        try {
            ...
            const response = await Services('https://jsonplaceholder.typicode.com').get(`/posts?userId=${userId}`)
